...
with tab_test:
    ...
    # Updated cellRenderer using a JavaScript class
    cell_renderer = JsCode("""
    class UrlCellRenderer {
      init(params) {
        this.eGui = document.createElement('a');
        this.eGui.innerText = params.value;
        this.eGui.setAttribute('href', '/Model_Details?option=' + params.value);
    ...
    """)
    gb.configure_column("run_id", cellRenderer=cell_renderer, width=300)
...
with tab_train:
    ...
    a2 = AgGrid(dte4, grid_optionst, allow_unsafe_jscode=True, unsafe_allow_html=True, theme="streamlit",
